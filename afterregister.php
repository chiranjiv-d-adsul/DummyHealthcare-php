  ...
  <div class="background-image">
      <div class="form-container">
        <div class="form-toggle">
          <button id="login-toggle-btn" >Log in</button>
          <button id="register-toggle-btn" class="active" >Register</button>
        </div>
        <div id="login-form"  style="display:none;">
          ...
          <?php if(isset($_SESSION['signup-sucess'])) : ?>
            ...
            <?php endif ?>
          <form action="signin-logic.php" method="POST" enctype="multipart/form-data">
...
/* form */
  ...
  .background-image {
    background-image: url('p6/images/loginf.jpg');
    background-size: 100%;
  ...
  .form-container {
    ...
    font-size: 20px;
    display: auto;
    background-image: url("p6/images/login.jpg");
